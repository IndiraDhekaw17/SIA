  ...
  @csrf
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="kode_akun" placeholder="Kode akun">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="decimal" class="form-control" name="saldo_awal" placeholder="Saldo awal">
                </div>

                <div class="form-group">
                  <label for="exampleInputPassword1">Saldo Akhir</label>
                  <input type="decimal" class="form-control" name="saldo_akhir" placeholder="Saldo akhir">
                </div>

                <div class="form-group">
                  <label for="exampleInputPassword1">Kategori</label>
                  <input type="decimal" class="form-control" name="kategori" placeholder="kategori">
                </div>
