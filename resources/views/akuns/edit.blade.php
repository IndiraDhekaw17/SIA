    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('akuns.index') }}"> Kembali</a>
            </div>
        </div>
    </div>
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="kode_akun" value="{{ $akun->kode_akun }}"  placeholder="Kode Akun">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Nama Akun:</strong>
                    <input type="text" class="form-control" name="nama_akun" value="{{ $akun->nama_akun }}" placeholder="Nama Akun">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Saldo Awal:</strong>
                    <input type="number" class="form-control" name="saldo_awal" value="{{$akun->saldo_awal }}" placeholder="Saldo Akhir">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Saldo Akhir:</strong>
                    <input type="number" class="form-control" name="saldo_akhir" value="{{ $akun->saldo_akhir }}" placeholder="Saldo Awal">
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="kategori" value="{{ $akun->kategori }}" placeholder="Kategori">
                </div>
            </div>
