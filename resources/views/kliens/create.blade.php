      ...
      <center>
        <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title"><b>TAMBAH DATA KLIEN</b></h3>
            </div>
  ...
  @csrf
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="kode_klien" placeholder="Kode Klien">
                </div>
                ...
                <div class="form-group">
                  <label>Ammount</label>
                  <input type="number" class="form-control" name="ammount" placeholder="Ammount">
                </div>
