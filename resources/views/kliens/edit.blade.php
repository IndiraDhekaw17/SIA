...
<head>
  ...
  <title>SIA | Data Klien & Perusahaan</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="height: 60px">
    ...
    <ul class="navbar-nav ml-auto" style="align-items: center">
      ...
      <li class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <a class="image">
          <img src="../../dist/img/user2-160x160.jpg" class="img-circle" style="margin-top:20px" alt="User Image">
        </a>
        </center>
        <div class="info">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2><center>Edit Data Klien</center></h2>
            </div>
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('kliens.index') }}"> Kembali</a>
            </div>
        </div>
    </div>
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Kode Klien:</strong>
                    <input type="text" class="form-control" name="kode_klien" value="{{ $klien->kode_klien }}" placeholder="Kode Klien">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Date:</strong>
                    <input type="date" class="form-control" name="date" value="{{ $klien->date }}" placeholder="Tanggal">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Nama Klien:</strong>
                    <input type="text" class="form-control" name="nama_klien" value="{{ $klien->nama_klien }}" placeholder="Nama Klien">
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="alamat" value="{{ $klien->alamat }}" placeholder="Alamat">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Ammount:</strong>
                    <input type="text" class="form-control" name="ammount" value="{{ $klien->ammount }}" placeholder="Ammount">
                </div>
            </div>

            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">Simpan</button>
                  <!-- Modal -->
                  <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" style="text-align: center;"  id="exampleModalLongTitle"><b><center>Edit Data</center></b></h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body">
                          <p>Apakah anda yakin ingin mengedit data?</p>
                        </div>
