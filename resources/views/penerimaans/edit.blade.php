...
<head>
  ...
  <title>SIA | Penerimaaan Kas atau Bank</title>
      ...
      <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('penerimaans.index') }}"> Kembali</a>
            </div>
        </div>
    </div>
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="integer" class="form-control" name="kode_akun" value="{{ $penerimaan->kode_akun }}" placeholder="Kode Akun">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Keterangan:</strong>
                    <input type="varchar" class="form-control" name="keterangan" value="{{ $penerimaan->keterangan }}" placeholder="Keterangan">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Debit:</strong>
                    <input type="decimal" class="form-control" name="debit" value="{{ $penerimaan->debit }}" placeholder="Debit">
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Kredit:</strong>
                    <input type="decimal" class="form-control" name="kredit" value="{{ $penerimaan->kredit }}" placeholder="Kredit">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Nama Akun:</strong>
                    <input type="char" class="form-control" name="nama_akun" value="{{ $penerimaan->nama_akun }}" placeholder="Nama Akun">
                </div>
            </div>
