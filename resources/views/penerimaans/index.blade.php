...
<head>
  ...
  <title>SIA | Penerimaan Kas atau Bank</title>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="kode_voucher" placeholder="Kode Voucher" value="<?php $a = "KM ";
                                                                                                                  $b = sprintf("%'.09d\n", 1, 10000);
                                                                                                                  $c = $a . $b;
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" name="terima" placeholder="Diterima Dari">
                  </div>
                  <div class="col-md-12">
                    <label>Kas/Bank</label>
                    <select type="text" class="form-control" name="kas_bank" placeholder="Kas atau Bank">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <input type="number" class="form-control" name="total_terima" placeholder="Total Terima">
          </div>
          <div class="col-md-12">
            <label>Saldo Akhir</label>
            <input type="number" class="form-control" name="saldo_akhir" placeholder="Saldo Akhir">
          </div>
        </div>
      </div>
  </div>
  ...
  <center>
    <div class="card">
      <div class="card-header">
        <h2 class="m-0"><b>Penerimaan Kas atau Bank</b></h2>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-lg-12 margin-tb">
            <div class="pull-right">
              <br>
              <a class="btn btn-success" href="{{ route('penerimaans.create') }}"> Tambah</a>
        ...
        <table class="table table-bordered">
          ...
          <tr>
            <td>{{ ++$i }}</td>
            <td>{{ $penerimaan->kode_akun }}</td>
            <td>{{ $penerimaan->keterangan }}</td>
            <td>{{ $penerimaan->debit }}</td>
            <td>{{ $penerimaan->kredit }}</td>
            <td>{{ $penerimaan->nama_akun }}</td>
            <td>
              <form action="{{ route('penerimaans.destroy',$penerimaan->id) }}" method="POST">
