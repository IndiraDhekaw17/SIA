...
<head>
  ...
  <title>SIA | Pengeluaran Kas atau Bank</title>
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="integer" class="form-control" name="kode_akun" value="{{ $pengeluaran->kode_akun }}" placeholder="Kode Akun">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Keterangan:</strong>
                    <input type="varchar" class="form-control" name="keterangan" value="{{ $pengeluaran->keterangan }}" placeholder="Keterangan">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Debit:</strong>
                    <input type="decimal" class="form-control" name="debit" value="{{ $pengeluaran->debit }}" placeholder="Debit">
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Kredit:</strong>
                    <input type="decimal" class="form-control" name="kredit" value="{{ $pengeluaran->kredit }}" placeholder="Kredit">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Nama Akun:</strong>
                    <input type="char" class="form-control" name="nama_akun" value="{{ $pengeluaran->nama_akun }}" placeholder="Nama Akun">
                </div>
            </div>
