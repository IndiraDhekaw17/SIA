              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="kode_voucher" placeholder="Kode Voucher" value="<?php $a = "KK ";
                                                                                                                  $b = sprintf("%'.09d\n", 1, 10000);
                                                                                                                  $c = $a . $b;
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <input type="number" class="form-control" name="total_terima" placeholder="Total Pembayaran">
          </div>
          <div class="col-md-12">
  ...
  <center>
    <div class="card">
      <div class="card-header">
        <h2 class="m-0"><b>Pengeluaran Kas atau Bank</b></h2>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-lg-12 margin-tb">
            <div class="pull-right">
              <br>
              <a class="btn btn-success" href="{{ route('pengeluarans.create') }}"> Tambah</a>
