...
<head>
  ...
  <title>SIA | Jurnal Penutup</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style=" background-color: #302E80;">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="https://trisaktipilarpersada.id/wp-content/uploads/2022/06/og.png"  class="brand-image img-circle elevation-3" style="opacity: .8">
...
<h5>
  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('penutups.index') }}"> Kembali</a>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('penutups.update', $penutup->id) }}" method="POST">
        @csrf
        @method('PUT')
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="kode_akun" value="{{ $penutup->kode_akun }}" placeholder="Kode Akun">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Keterangan:</strong>
                    <input type="text" class="form-control" name="keterangan" value="{{ $penutup->keterangan }}" placeholder="Keterangan">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Debit:</strong>
                    <input type="decimal" class="form-control" name="debit" value="{{ $penutup->debit }}" placeholder="Debit">
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Kredit:</strong>
                    <input type="decimal" class="form-control" name="kredit" value="{{ $penutup->kredit }}" placeholder="Kredit">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Nama Akun:</strong>
                    <input type="text" class="form-control" name="nama_akun" value="{{ $penutup->nama_akun }}" placeholder="Nama Akun">
                </div>
            </div>
