    ...
    <center>
      <div class="card">
        <div class="card-header">
          <h2 class="m-0"><b>Jurnal Penutup</b></h2>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12 margin-tb">
              <div class="pull-right">
                <br>
                <a class="btn btn-success" href="{{ route('penutups.create') }}"> Tambah</a>
          ...
          <table class="table table-bordered">
            ...
            <tr>
              <td>{{ $penutup->kode_akun }}</td>
              <td>{{ $penutup->keterangan }}</td>
              <td>{{ $penutup->debit }}</td>
              <td>{{ $penutup->kredit }}</td>
              <td>{{ $penutup->nama_akun }}</td>
              <td>
                <form action="{{ route('penutups.destroy',$penutup->id) }}" method="POST">

                  <a class="btn btn-primary" href="{{ route('penutups.edit',$penutup->id) }}">Edit</a>
